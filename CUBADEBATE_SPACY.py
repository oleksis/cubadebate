    ...
    try:
        with session:
            ...
            if response.status_code == 200:
                ...
                return results
    except ConnectionErrorRequests as error:
        pass
...
documents_normalized = list(*dask.compute(get_documents_normalized(documents)))  # type: List[List[str]]
...
if not os.path.isfile(IMG_CAPITOLIO):
    ...
    image_downloaded = IMG_CAPITOLIO.split("\\")[-1].split("/")[-1]  # type: str
